        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            <input
              ...
              placeholder="Search..."
              className="w-64 pl-9 pr-3 py-2 rounded-xl bg-slate-100 text-sm text-slate-700 focus:ring-2 focus:ring-blue-500 outline-none"
            />
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
              className="h-4 w-4 absolute left-3 top-2.5 text-slate-400"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
          </div>
