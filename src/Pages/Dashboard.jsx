...
const mock = {
  ...
  salesSeries: [
    220, 320, 410, 380, 520, 640, 590, 720, 680, 860, 910, 1040,
  ], // 12 months
  ...
  return (
    <div className="flex gap-6 items-center">
      <svg width={size} height={size} className="shrink-0">
        ...
        {donut && (
          <circle cx={R} cy={R} r={R * 0.55} className="fill-white" />
        )}
      </svg>
...
function SummaryCard({ label, value, delta = 0, prefix = "", Icon }) {
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm ring-1 ring-slate-100">
      ...
      <div className="mt-4 text-3xl font-semibold tracking-tight">{prefix}{fmt(value)}</div>
...
function CartIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M7 18a2 2 0 1 0 0 4a2 2 0 0 0 0-4m10 0a2 2 0 1 0 0 4a2 2 0 0 0 0-4M7.16 14h9.71a2 2 0 0 0 1.94-1.52l1.9-8A1 1 0 0 0 19.76 3H5.21l-.36-2H1v2h2l2.6 12.39A3 3 0 0 0 8.53 17H19v-2H8.53a1 1 0 0 1-1-.78z"/></svg>
  );
}
function BoxIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M21 16V8a1 1 0 0 0-.55-.89l-8-4a1 1 0 0 0-.9 0l-8 4A1 1 0 0 0 3 8v8a1 1 0 0 0 .55.89l8 4a1 1 0 0 0 .9 0l8-4A1 1 0 0 0 21 16M12 5.24L17.53 8L12 10.76L6.47 8zM5 9.47l6 3.29v6.77l-6-3zM13 19.53v-6.77l6-3v6.77z"/></svg>
  );
}
function UsersIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5s-3 1.34-3 3s1.34 3 3 3m-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5S5 6.34 5 8s1.34 3 3 3m0 2c-2.33 0-7 1.17-7 3.5V20h14v-3.5C15 14.17 10.33 13 8 13m8 0c-.29 0-.62.02-.97.05C16.76 13.82 18 14.9 18 16.5V20h6v-3.5c0-2.33-4.67-3.5-8-3.5"/></svg>
  );
}
function WalletIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M21 7H3a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h18a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1m-2 8h-3a2 2 0 0 1 0-4h3zM17 6H5a1 1 0 0 1 0-2h12a2 2 0 0 1 2 2z"/></svg>
  );
}
function SearchIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="m21 21l-4.35-4.35A7.94 7.94 0 0 0 18 10a8 8 0 1 0-8 8a7.94 7.94 0 0 0 6.65-3.35L21 21M4 10a6 6 0 1 1 6 6a6 6 0 0 1-6-6"/></svg>
  );
}
function BellIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}><path fill="currentColor" d="M12 2a7 7 0 0 0-7 7v3.29l-1.71 1.7A1 1 0 0 0 4 16h16a1 1 0 0 0 .71-1.71L19 12.29V9a7 7 0 0 0-7-7m0 20a3 3 0 0 0 3-3H9a3 3 0 0 0 3 3"/></svg>
  );
}
