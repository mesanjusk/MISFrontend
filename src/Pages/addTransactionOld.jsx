...
export default function AddTransactionOld({ editMode, existingData, onClose, onSuccess }) {
  ...
  const submit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("/old-transaction/addTransaction", formData, {
